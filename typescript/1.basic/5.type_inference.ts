...
// yuJin3.name = '코드팩토리' This line throws an error becuase name is set for 'const'
...
// numbers.push('6') this line throws an error becuase numbers is Array Number type
const number = numbers[0]
const nos = numbersAndString[0]
const nos2 = numbersAndString[100] // TS doesn't care the size of the array.
